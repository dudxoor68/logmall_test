	...
	<header>
		<div>
            ...
            <div class="pro">
                ...
                <img src="./img/pro7.jpg" class="proImg">
                <div class="proName">
                    <p class="proa">시그마 기타 DMC-STE Sigma DMC-STE</p>
                    <p class="prob">가격: 580,000원</p>
                    <hr style="border:solid 1px #c0c0c0; width:700px; "></hr>
                    <p>적립금: 5,800</p>
                    <p>원래가격: 640,000</p>
                    <p>판매가격: 580,000</p>
                    ...
                    <div style="border:1px solid #c0c0c0; width:400px; height:30px; margin:10px;">
                        <p style="position:relative; top:-10px; left:100px;">총결제금액: 580,000원</p>
                    </div>
					...
					<form  name="cart_form" method="post" action="cart_insert.php">
						...
						<input name="name" type="hidden" value="시그마 기타 DMC-STE Sigma DMC-STE">
						<input name="amount" type="hidden" value="1">
						<input name="point" type="hidden" value="5800">
						<input name="price" type="hidden" value="580000">
