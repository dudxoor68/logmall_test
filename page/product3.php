 ...
 <body>
	...
	<header>
		<div>
            ...
            <div class="pro">
                <div class="cate">
                    <p style="font-size:14px; color:#888888; ">베스트모음-40~50만원대 best</p>
                    <hr style="border:solid 1px #c0c0c0; width:700px; "></hr>
                </div>
                <img src="./img/pro3.jpg" class="proImg">
                <div class="proName">
                    <p class="proa">로그기타 2023 Hebron G3</p>
                    <p class="prob">가격: 450,000원</p>
                    <hr style="border:solid 1px #c0c0c0; width:700px; "></hr>
                    <p>적립금: 4,500</p>
                    <p>원래가격: 630,000</p>
                    <p>판매가격: 450,000</p>
                    ...
                    <div style="border:1px solid #c0c0c0; width:400px; height:30px; margin:10px;">
                        <p style="position:relative; top:-10px; left:100px;">총결제금액: 450,000원</p>
                    </div>
                    <button class="button1">관심상품</button>
                   

					<form  name="cart_form" method="post" action="cart_insert.php">
						<input name="img" type="hidden" value="./img/pro3.jpg">
						<input name="name" type="hidden" value="로그기타 2023 Hebron G3">
						<input name="amount" type="hidden" value="1">
						<input name="point" type="hidden" value="4500">
