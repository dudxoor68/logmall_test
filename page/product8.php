 ...
 <body>
	...
	<header>
		<div>
            ...
            <div class="pro">
                <div class="cate">
                    <p style="font-size:14px; color:#888888; ">베스트모음-80~90만원대 best</p>
                    <hr style="border:solid 1px #c0c0c0; width:700px; "></hr>
                </div>
                <img src="./img/pro8.jpg" class="proImg">
                <div class="proName">
                    <p class="proa">로그기타 Hebron G7 L.R Baggs VTC 장착</p>
                    <p class="prob">가격: 990,000원</p>
                    <hr style="border:solid 1px #c0c0c0; width:700px; "></hr>
                    <p>적립금: 9,900</p>
                    <p>원래가격: 1,100,000</p>
                    <p>판매가격: 990,000</p>
                    ...
                    <div style="border:1px solid #c0c0c0; width:400px; height:30px; margin:10px;">
                        <p style="position:relative; top:-10px; left:100px;">총결제금액: 990,000원</p>
                    </div>
					...
					<form  name="cart_form" method="post" action="cart_insert.php">
						...
						<input name="name" type="hidden" value="로그기타 Hebron G7 L.R Baggs VTC 장착">
						<input name="amount" type="hidden" value="1">
						<input name="point" type="hidden" value="9900">
						<input name="price" type="hidden" value="990000">
