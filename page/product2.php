	...
	<header>
		<div>
            ...
            <div class="pro">
                ...
                <img src="./img/pro2.jpg" class="proImg">
                <div class="proName">
                    <p class="proa">핵스 HIVE F101G 유광</p>
                    <p class="prob">가격: 290,000원</p>
                    <hr style="border:solid 1px #c0c0c0; width:700px; "></hr>
                    <p>적립금: 2,900</p>
                    <p>원래가격: 360,000</p>
                    <p>판매가격: 290,000</p>
                    ...
                    <div style="border:1px solid #c0c0c0; width:400px; height:30px; margin:10px;">
                        <p style="position:relative; top:-10px; left:100px;">총결제금액: 290,000원</p>
                    </div>
                    <button class="button1">관심상품</button>
                   

					<form  name="cart_form" method="post" action="cart_insert.php">
						<input name="img" type="hidden" value="./img/pro2.jpg">
						<input name="name" type="hidden" value="핵스 HIVE F101G 유광">
						<input name="amount" type="hidden" value="1">
						<input name="point" type="hidden" value="2900">
						<input name="price" type="hidden" value="290000">
