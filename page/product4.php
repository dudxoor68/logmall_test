	...
	<header>
		<div>
            ...
            <div class="pro">
                ...
                <img src="./img/pro4.jpg" class="proImg">
                <div class="proName">
                    <p class="proa">고퍼우드 i210RS 주니어 통기타 탑솔리드</p>
                    <p class="prob">가격: 320,000원</p>
                    <hr style="border:solid 1px #c0c0c0; width:700px; "></hr>
                    <p>적립금: 3,200</p>
                    <p>원래가격: 410,000</p>
                    <p>판매가격: 320,000</p>
                    ...
                    <div style="border:1px solid #c0c0c0; width:400px; height:30px; margin:10px;">
                        <p style="position:relative; top:-10px; left:100px;">총결제금액: 320,000원</p>
                    </div>
                    <button class="button1">관심상품</button>
                   

					<form  name="cart_form" method="post" action="cart_insert.php">
						<input name="img" type="hidden" value="./img/pro4.jpg">
						<input name="name" type="hidden" value="고퍼우드 i210RS 주니어 통기타 탑솔리드">
						<input name="amount" type="hidden" value="1">
						<input name="point" type="hidden" value="4100">
						<input name="price" type="hidden" value="320000">
